...
### -EnableHTTPRedirect
Indicates that this cmdlet enables HTTP redirect for Web Application Proxy. Note that you will need to allow the traffic on port TCP 80 on the WAP servers expecting to use this publication. Here is an example in PowerShell to create such rule: 
```
